...
CREATE TABLE ETL.RAD_NewAttempts_EX1 -- Temp
(
...
CREATE TABLE ETL.RAD_DISPATTEMPTS_EX2
(
  COLLECTIONKEY     NUMBER(11)                  NOT NULL,
  CUSTOMERKEY       NUMBER(11),
...
CREATE TABLE ETL.RAD_AttemptGroupAssoc_EX2 -- Temp
(
Customerkey         NUMBER(11), 
...
/
CREATE TABLE ETL.RAD_NEWATTEMPTS_STATS_EX3
(
  COLLECTIONGROUPKEY  NUMBER(11),
  NEWATTEMPTS         NUMBER,
...
CREATE TABLE ETL.RAD_New_Collection_Groups -- Temp
(
Customerkey         NUMBER(11), 
...
/
CREATE TABLE ETL.RAD_ACTIVE_GROUPS_EX1
(
  CUSTOMERKEY               NUMBER(11),
  COLLECTIONGROUP           NUMBER(11),
  COLLECTIONGROUPSTARTDATE  DATE,
...
CREATE TABLE ETL.RAD_NEW_COLLECTION_GROUPS_EX3
(
  CUSTOMERKEY      NUMBER(11),
...
CREATE TABLE ETL.RAD_New_Collection_Groups_EX1 -- Temp
(
Customerkey         NUMBER(11), 
CollectionGroup     NUMBER(11),
CollectionGroupStartDate DATE,
...
/
CREATE TABLE ETL.RAD_NEW_GROUP_STATS -- Temp
(
  CUSTOMERKEY               NUMBER(11),
  COLLECTIONGROUP           NUMBER(11),
  COLLECTIONGROUPSTARTDATE  DATE,
...
CREATE BITMAP INDEX ETL.RAD_NEWGROUP_NG_BI ON ETL.RAD_NEW_GROUP_STATS
(NEW_GROUP_FLAG)
LOGGING
/*
...
CREATE BITMAP INDEX ETL.RAD_NEW_GROUP_CF_BI ON ETL.RAD_NEW_GROUP_STATS
(COLLECTED_FLAG)
LOGGING
--TABLESPACE USERS_NEW
PCTFREE    10
...
/
--DROP TABLE ETL.RAD_NEWATTEMPTS_STATS_EX5 CASCADE CONSTRAINTS;
/*
CREATE TABLE ETL.RAD_NEWATTEMPTS_STATS_EX5
(
  COLLECTIONGROUPKEY  NUMBER(11),
  NEWATTEMPTS         NUMBER,
  MOSTRECENTATTEMPT   NUMBER
...
CREATE TABLE ETL.RAD_Collection_Groups --Perm
(
Customerkey         NUMBER(11), 
CollectionGroup     NUMBER(11),
CollectionGroupStartDate DATE,
...
CREATE BITMAP INDEX ETL.RAD_FINALSTATUS_BI ON ETL.RAD_COLLECTION_GROUPS
(FINAL_STATUS_FLAG)
LOGGING
/*TABLESPACE USERS_NEW
PCTFREE    10
...
CREATE TABLE ETL.RAD_Collection_Group_Disp_CF1 --Temp
(
  CUSTOMERKEY               NUMBER(11),
...
CREATE TABLE ETL.RAD_Collection_Group_Disp --Perm
(
  CUSTOMERKEY               NUMBER(11),
  COLLECTIONGROUP           NUMBER,
  COLLECTIONGROUPSTARTDATE  DATE,
...
/
/*
CREATE TABLE ETL.RETRY_ANALYSIS_ACTIVE --Perm
(
  CUSTOMERKEY                NUMBER(11),
  COLLECTIONKEY              NUMBER(11)         NOT NULL,
  MARKETINGREGION            VARCHAR2(40 CHAR),
...
/
/*
select * from ETL.RAD_NewAttempts
select * from ETL.RAD_New_Collection_Groups
/
select * from ETL.RAD_New_Collection_Groups_EX1 
/
select * from ETL.RAD_NEW_GROUP_STATS
/
select * from ETL.RAD_Active_Collection_Groups 
/
select * from ETL.RAD_Final_Collection_Groups 
/
select * from ETL.RAD_Active_Collection_Groups 
/
select * from ETL.RAD_Collection_Group_Disp
/
...
CREATE TABLE ETL.RAD_Final_Collection_Groups --Perm
(
Customerkey         NUMBER(11), 
CollectionGroup     NUMBER(11),
CollectionGroupStartDate DATE,
...
CREATE TABLE ETL.RAD_Active_Collection_Groups --Perm
(
Customerkey         NUMBER(11), 
CollectionGroup     NUMBER(11),
CollectionGroupStartDate DATE,
