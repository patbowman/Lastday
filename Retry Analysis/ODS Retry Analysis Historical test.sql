...
insert into  pbowman.rad_newattempts_ex1 
    ...
    where   requestdate >= '31-DEC-2000' 
    and requestdate < '31-DEC-2002'
...
commit;
truncate table rad_dispattempts_ex2;
...
and requestdate  between '01-JAN-2000' and '01-JAN-2004' --between '01-JAN-2018' and sysdate -- right now, use a year before start date, though that's overkill.
and ods_current_flag =1;
...
truncate table rad_active_groups_ex1;
...
truncate table RAD_Collection_Group_Disp_CF1;
...
--select * from RAD_New_Collection_Groups_EX3
 ...
 --create table RAD_Final_check as 
