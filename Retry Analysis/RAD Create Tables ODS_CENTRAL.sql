...
CREATE TABLE ODS_CENTRAL.RAD_NewAttempts_EX1 -- Temp
(
...
CREATE TABLE ODS_CENTRAL.RAD_DISPATTEMPTS_EX2
(
  COLLECTIONKEY     NUMBER(11)                  NOT NULL,
  CUSTOMERKEY       NUMBER(11),
...
CREATE TABLE ODS_CENTRAL.RAD_AttemptGroupAssoc_EX2 -- Temp
(
Customerkey         NUMBER(11), 
...
/
CREATE TABLE ODS_CENTRAL.RAD_NEWATTEMPTS_STATS_EX3
(
  COLLECTIONGROUPKEY  NUMBER(11),
  NEWATTEMPTS         NUMBER,
...
CREATE TABLE ODS_CENTRAL.RAD_New_Collection_Groups -- Temp
(
Customerkey         NUMBER(11), 
...
/
CREATE TABLE ODS_CENTRAL.RAD_ACTIVE_GROUPS_EX1
(
  CUSTOMERKEY               NUMBER(11),
  COLLECTIONGROUP           NUMBER(11),
  COLLECTIONGROUPSTARTDATE  DATE,
...
CREATE TABLE ODS_CENTRAL.RAD_NEW_COLLECTION_GROUPS_EX3
(
  CUSTOMERKEY      NUMBER(11),
...
CREATE TABLE ODS_CENTRAL.RAD_New_Collection_Groups_EX1 -- Temp
(
Customerkey         NUMBER(11), 
CollectionGroup     NUMBER(11),
CollectionGroupStartDate DATE,
...
/
CREATE TABLE ODS_CENTRAL.RAD_NEW_GROUP_STATS -- Temp
(
  CUSTOMERKEY               NUMBER(11),
  COLLECTIONGROUP           NUMBER(11),
  COLLECTIONGROUPSTARTDATE  DATE,
...
CREATE BITMAP INDEX ODS_CENTRAL.RAD_NEWGROUP_NG_BI ON ODS_CENTRAL.RAD_NEW_GROUP_STATS
(NEW_GROUP_FLAG)
LOGGING
TABLESPACE USERS_NEW
PCTFREE    10
...
CREATE BITMAP INDEX ODS_CENTRAL.RAD_NEW_GROUP_CF_BI ON ODS_CENTRAL.RAD_NEW_GROUP_STATS
(COLLECTED_FLAG)
LOGGING
TABLESPACE USERS_NEW
PCTFREE    10
...
/
--DROP TABLE ODS_CENTRAL.RAD_NEWATTEMPTS_STATS_EX5 CASCADE CONSTRAINTS;
/*
CREATE TABLE ODS_CENTRAL.RAD_NEWATTEMPTS_STATS_EX5
(
  COLLECTIONGROUPKEY  NUMBER(11),
  NEWATTEMPTS         NUMBER,
  MOSTRECENTATTEMPT   NUMBER
...
CREATE TABLE ODS_CENTRAL.RAD_Collection_Group_Disp_CF1 --Temp
(
  CUSTOMERKEY               NUMBER(11),
...
/
/*
select * from ODS_CENTRAL.RAD_NewAttempts
select * from ODS_CENTRAL.RAD_New_Collection_Groups
/
select * from ODS_CENTRAL.RAD_New_Collection_Groups_EX1 
/
select * from ODS_CENTRAL.RAD_NEW_GROUP_STATS
/
select * from ODS_CENTRAL.RAD_Active_Collection_Groups 
/
select * from ODS_CENTRAL.RAD_Final_Collection_Groups 
/
select * from ODS_CENTRAL.RAD_Active_Collection_Groups 
/
select * from ODS_CENTRAL.RAD_Collection_Group_Disp
/
...
CREATE TABLE ODS_CENTRAL.RAD_Final_Collection_Groups --Perm
(
Customerkey         NUMBER(11), 
CollectionGroup     NUMBER(11),
CollectionGroupStartDate DATE,
...
CREATE TABLE ODS_CENTRAL.RAD_Active_Collection_Groups --Perm
(
Customerkey         NUMBER(11), 
CollectionGroup     NUMBER(11),
CollectionGroupStartDate DATE,
